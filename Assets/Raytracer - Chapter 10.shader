...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		void set_face_normal(Ray r, vec3 outward_normal, inout Hit_record h)
		{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		Sphere makeSphere(vec3 center, float radius, bool isMetal, col3 albedo, float fuzz)
		{
			Sphere s;
			s.center = center;
			s.radius = radius;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		static const Sphere WORLD[NUMBER_OF_SPHERES] = {
			{ vec3(0.0, 0.0, -1.0), 0.5 , false, col3(0.1, 0.2, 0.5), 0.5},
			{ vec3(0.0, -100.5, -1.0), 100.0 , false, col3(0.8, 0.8, 0.0), 0.0},
			{ vec3(1.0, 0.0, -1.0), 0.5 , true, col3(0.8, 0.6, 0.2), 1.0},
			{ vec3(-1.0, 0.0, -1.0), 0.5 , true, col3(0.8, 0.8, 0.8), 0.3}
		};
