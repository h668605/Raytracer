...
_floatchooserRays("numberOfRays", Range(3,1000)) = 3
_floatchooserBounce("bounceAmount", Range(1,20)) = 2
_cameraPosition("cameraPosition", Vector) = (-1,2,1,0)
_lookAt("LookAt", Vector) = (-2, -1, -1, 0)
_moveSphere("moveSphere", range(-4,4)) = 0
_refractionGlass("refractionGlass",Range(-1,3)) = 0.66
	...
	float _floatchooserRays;
	int _floatchooserBounce;
	float4 _cameraPosition;
	float4 _lookAt;
	float _moveSphere;
	float _refractionGlass;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		struct Camera
	{
		...
		Camera MakeCamera()
		{
			...
			c.lower_left_corner = vec3(_lookAt.x, _lookAt.y, _lookAt.z);
			c.horizontal = vec3(4, 0, 0);
			c.vertical = vec3(0, 2, 0);
			c.origin = vec3(_cameraPosition.x, _cameraPosition.y, _cameraPosition.z);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		static const Sphere WORLD[NUMBER_OF_SPHERES] = {
			{ vec3(_moveSphere, 0.0, -1.2), 0.5 , col3(0.1, 0.2, 0.5), 0.5,false,false, 0.0},
			{ vec3(0.0, -100.5, -1.0), 100.0 , col3(0.8, 0.8, 0.0), 0.0,false,false, 0.0},
			{ vec3(1.0, 0.0, -1.0), 0.5 , col3(0.8, 0.6, 0.2), 0.5,true,false, 0.0},
			{ vec3(-1.0, 0.0, -1.0), 0.5 , col3(1.0, 1.0, 1.0), 0.0,false,true, _refractionGlass}
		};
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		int sampleNumber = _floatchooserRays;
		...
		{
			float dx = (random_float(xy)* (2/_ScreenParams.x));
			float dy = (random_float(xy)*(1/_ScreenParams.y));
