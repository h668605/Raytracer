		...
		col3 beginTracing(Ray ray, float2 xy)
		{
			...
			float closest_t = 10000.0;
                ...
                while (hit_anything && (maxC > 0) ){
                	...
                	Ray r = MakeRay(record.position, direction);
					accumCol = 0.5*accumCol;
                	
                	hit_anything = calculateSpheresIntersect(0.001,closest_t, r, record);
                }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	fixed4 frag(v2f i) : SV_Target
	{
		...
		{
			float dx = (random_float(xy) /_ScreenParams.x);
			float dy = (random_float(xy) /_ScreenParams.y);
